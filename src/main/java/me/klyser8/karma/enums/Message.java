...
public enum Message {
    ...
    SCORE_ADDED_SUCCESSFULLY("&d[Karma] &fYou have given yourself &a<NUMBER> &fKarma points."),
    SCORE_REMOVED_SUCCESSFULLY("&d[Karma] &fYou have removed &c<NUMBER> &fKarma points from yourself."),
    SCORE_SET_SUCCESSFULLY("&d[Karma] &fYou set your Karma Score to &e<NUMBER>."),
    SCORE_CLEARED_SUCCESSFULLY("&d[Karma] &fYou cleared your Karma score."),
    VIEW_SCORE_SELF("&d[Karma] &fYour Karma score is &e<NUMBER>"),
    VIEW_ALIGNMENT_SELF("&d[Karma] &fYour alignment is <ALIGNMENT> &f."),

    SCORE_ADDED_SUCCESSFULLY_SELF("&d[Karma] &fGiven &a<NUMBER> &fKarma points to &e<PLAYER>."),
    SCORE_REMOVED_SUCCESSFULLY_SELF("&d[Karma] &fRemoved &c<NUMBER> &fKarma points from &e<PLAYER>."),
    SCORE_SET_SUCCESSFULLY_SELF("&d[Karma] &fSet &e<PLAYER>&f's Karma score to &e<NUMBER>."),
    SCORE_CLEARED_SUCCESSFULLY_SELF("&d[Karma] &fCleared &e<PLAYER>&f's Karma score."),
